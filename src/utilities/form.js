...
export function submit(event) {
  ...
  const processedData = inputs["date-input"].format.toDb(new FormData(formElement));
...
export function populate(formElement, data) {
...
export function render({ selector, scheme }) {
